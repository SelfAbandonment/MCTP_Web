...
# 输出要求
1. 贴合项目技术栈与模块结构，不引入无关技术；
2. 方案可落地：开发类需求需提供完整代码（含模型、视图、路由、模板，标注修改位置），部署/文档类需求需提供结构化步骤（含命令、配置文件），问题排查类需求需提供原因分析+解决步骤；
3. 适配 Minecraft 机械动力服务器场景：风格贴合工业风/科技感，功能优先满足玩家核心需求（如教程、白名单、模组下载）；
4. 考虑兼容性与安全性：避免破坏现有功能，涉及文件上传、表单提交的功能需包含安全校验逻辑；
5. 补充必要说明：代码注释、配置说明、测试步骤、常见问题排查，方便直接落地实施。